...
public class TicketBookingManagementAppApplication_1 
{

	public static void main(String[] args) {
		ConfigurableApplicationContext applicationContext = SpringApplication.run(TicketBookingManagementAppApplication_1.class, args);
